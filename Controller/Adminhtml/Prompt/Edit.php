...
class Edit extends \Magento2Developer\ChatGPT\Controller\Adminhtml\Prompt
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('magento2developer_chatgpt_prompt', $model);
        
        // 3. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Prompt') : __('New Prompt'),
            $id ? __('Edit Prompt') : __('New Prompt')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Prompts'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Prompt %1', $model->getId()) : __('New Prompt'));
        return $resultPage;
    }
}
